...
[the GitHub repo page](https://github.com/js2264/scRNAseq_Physalia_2025), click on the 
...
How many reads are there in the `fq.gz` file? And how long are they? Can you get a summary of what is in this file? All of these questions can be quickly answered using the [`seqkit`](https://bioinf.shenwei.me/seqkit/usage/) tool: 
...
::: {.callout-answer .icon .callout-note collapse="true"}
Check the [Geo Dataset search page](https://www.ncbi.nlm.nih.gov/gds/). 

[Search for `Leir 2020 CFTF`](https://www.ncbi.nlm.nih.gov/gds/?term=leir+2020+CFTR). 
You should find the [following entry](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE148963). 
